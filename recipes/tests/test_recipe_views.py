...
class RecipeViewsTest(RecipeTestBase):
    ...
    def test_recipe_category_view_returns_status_code_404_if_no_recipes_found(self):
        response = self.client.get(
            reverse('recipes:category', kwargs={'category_id': 1001}))
    ...
    def test_recipe_category_template_dont_load_recipes_not_published(self):
        ...
        response = self.client.get(
            reverse('recipes:category', args=(recipe.category.id, )))  # type: ignore
    ...
    def test_recipe_detail_view_returns_status_code_404_if_no_recipes_found(self):
        response = self.client.get(
            reverse('recipes:recipe', kwargs={'id': 1001}))
        self.assertEqual(response.status_code, 404)
    ...
    def test_recipe_detail_template_dont_load_recipe_not_published(self):
        ...
        response = self.client.get(
            reverse('recipes:recipe', args=(recipe.id, )))  # type: ignore
