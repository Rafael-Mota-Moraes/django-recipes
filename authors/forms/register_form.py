...
class RegisterForm(forms.ModelForm):
    ...
    username = forms.CharField(
        label='Username',
        help_text='Username must have letters, numbers or one of those @.=_. The length should be beetwen 4 and 150 characters.',
        error_messages={'required': 'This field must not be empty',
                        'min_length': 'Username must have at least 4 characters.', 'max_length': 'Username must have less then 150 characters'},
        min_length=4,
        max_length=150
    )
